            ...
            <div class="flex-col gap-10">
                <div class="re flex-row" :class="title_center">
                    <div class="z-i flex-row align-c gap-10">
                        ...
                        <div v-if="!isEmpty(form.subtitle) && form.title_line == '1'" class="text-word-break nowrap" :style="subtitle_style">{{ form.subtitle }}</div>
                    </div>
                ...
                <div v-if="!isEmpty(form.subtitle) && form.title_line != '1'" class="text-word-break" :style="subtitle_style">{{ form.subtitle }}</div>
            </div>
        </div>
    </div>
</template>
